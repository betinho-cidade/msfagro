                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Agora falta pouco !!!</h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <form name="reset_password" method="POST" action="{{route('reset')}}"  class="needs-validation" novalidate>
                                    @csrf
                                        ...
                                        <button class="btn btn-primary w-md waves-effect waves-light" style="background: #34aeee !important; border-color: #34aeee !important;" type="submit">Gerar nova senha</button>
                                </form>
