            ...
            <form name="edit_produtor" method="POST" action="{{route('produtor.update', compact('produtor'))}}"  class="needs-validation" accept-charset="utf-8" enctype="multipart/form-data" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="form-control mask_cpf_cnpj" value="{{$produtor->cpf_cnpj}}" placeholder="---" required>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="nome">Nome</label>
                            <input type="text" class="form-control" id="nome" name="nome" value="{{$produtor->nome}}" placeholder="Nome" required>
                            <div class="valid-feedback">ok!</div>
                            <div class="invalid-feedback">Inválido!</div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="{{$produtor->email}}" placeholder="E-mail" required>
                            <div class="valid-feedback">ok!</div>
                            <div class="invalid-feedback">Inválido!</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mask_telefone" id="telefone" name="telefone" value="{{$produtor->telefone}}" placeholder="Telefone">
                            <div class="valid-feedback">ok!</div>
                            <div class="invalid-feedback">Inválido!</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inscricao_estadual" name="inscricao_estadual" value="{{$produtor->inscricao_estadual}}" placeholder="Inscrição Estadual">
                            <div class="valid-feedback">ok!</div>
                            <div class="invalid-feedback">Inválido!</div>
                        </div>
                    </div>
            ...
            <div class="bg-soft-primary p-3 rounded" style="margin-bottom:10px;">
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <input type="text" name="end_cep" id="end_cep" class="form-control dynamic_cep mask_cep" value="{{$produtor->end_cep}}" placeholder="99.999-999">
                    </div>

                    <div class="col-md-4">
                        <label for="end_cidade">Cidade</label>
                        <input type="text" name="end_cidade" id="end_cidade" class="form-control" value="{{$produtor->end_cidade}}">
                    </div>

                    <div class="col-md-2">
                        <label for="end_uf">Estado</label>
                        <input type="text" name="end_uf" id="end_uf" class="form-control" value="{{$produtor->end_uf}}">
                    </div>

                    <div class="col-md-4">
                        <label for="end_bairro">Bairro</label>
                        <input type="text" name="end_bairro" id="end_bairro" class="form-control" value="{{$produtor->end_bairro}}">
                    </div>
                </div>
                <p></p>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="end_logradouro" id="end_logradouro" class="form-control" value="{{$produtor->end_logradouro}}">
                    </div>

                    <div class="col-md-2">
                        <label for="end_numero">Número</label>
                        <input type="text" name="end_numero" id="end_numero" value="{{$produtor->end_numero}}" class="form-control">
                    </div>

                    <div class="col-md-4">
                        <label for="end_complemento">Complemento </label>
                        <input type="text" name="end_complemento" id="end_complemento" class="form-control" value="{{$produtor->end_complemento}}">
                    </div>
                </div>
                <p></p>
            <!-- Dados Endereço - FIM -->
