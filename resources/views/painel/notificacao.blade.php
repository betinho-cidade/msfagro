    ...
    @if($notificacaos && $notificacaos->count() > 0)
        ...
        <div class="col-md-6 col-xl-6">
            <div class="card" style="height: 93%;">
                ...
                <div class="card-body" style="padding: 12px;max-height: 200px; overflow-y: auto;min-height:auto;">
                    ...
                    @else
                        <h4 class="card-title mt-0">{{ $notificacao->nome }}</h4>
                    @endif
                    <p class="card-text" style="font-size: 13px; line-height: 16px;">{!!$notificacao->resumo!!}</p>
                    @if($notificacao->url_notificacao)
