    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <a href="{{route("categoria.create")}}" class="btn btn-outline-secondary waves-effect">Nova Categoria</a>
            </div>
        </div>
    </div>
</div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#ativa" role="tab">
                            ...
                            <span class="d-none d-sm-block">Categorias Ativas ( <code class="highlighter-rouge">{{$categorias_AT->count()}}</code> )</span>
                        </a>
                    </li>
                    <li class="nav-item">
