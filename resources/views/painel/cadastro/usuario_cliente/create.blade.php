...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Novo Usuário do Cliente</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <h4 class="card-title">Formulário de Cadastro - Usuário do Cliente</h4>
            ...
            <form name="create_usuario_cliente" method="POST" action="{{route('usuario_cliente.store')}}"  class="needs-validation"  accept-charset="utf-8" enctype="multipart/form-data" novalidate>
                @csrf
