            ...
            <form name="edit_produtor" method="POST" action="{{route('produtor.update', compact('produtor'))}}"  class="needs-validation" accept-charset="utf-8" enctype="multipart/form-data" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="form-control {{($errors->first('cpf_cnpj') ? 'form-error-field' : '')}} mask_cpf_cnpj" value="{{$produtor->cpf_cnpj}}" placeholder="---" required>
                        <div class="valid-feedback">ok!</div>
                        <div class="invalid-feedback">Inválido!</div>
                    </div>
                    <div class="col-md-5">
