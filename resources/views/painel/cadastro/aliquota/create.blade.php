                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control updParcela mask_valor {{($errors->first('base_inicio') ? 'form-error-field' : '')}}" id="base_inicio_view" name="base_inicio_view" value="{{old('base_inicio_view')}}" placeholder="Base Início">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control updParcela mask_valor {{($errors->first('base_fim') ? 'form-error-field' : '')}}" id="base_fim_view" name="base_fim_view" value="{{old('base_fim_view')}}" placeholder="Base Fim">
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control updParcela mask_aliquota {{($errors->first('aliquota') ? 'form-error-field' : '')}}" id="aliquota_view" name="aliquota_view" value="{{old('aliquota_view')}}" placeholder="Alíquota">
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control updParcela mask_valor {{($errors->first('parcela_deducao') ? 'form-error-field' : '')}}" id="parcela_deducao_view" name="parcela_deducao_view" value="{{old('parcela_deducao_view')}}" placeholder="Parcela Dedução">
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
