                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#global" role="tab">
                            ...
                            <span class="d-none d-sm-block">Mov. Global ( <code class="highlighter-rouge valor_mask" onLoad="mascaraMoeda(event);" style="color:{{ ($saldo_global->saldo >= 0) ? 'blue' : 'red' }}">{{$saldo_global->saldo ?? 'R$ 0,00'}}</code> )
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#efetiva" role="tab">
                            <span class="d-block d-sm-none"><i class="ri-checkbox-circle-line"></i></span>
                            <span class="d-none d-sm-block">Mov. Efetiva ( <code class="highlighter-rouge valor_mask" onLoad="mascaraMoeda(event);" style="color:blue">{{$saldo_efetivo->receita ?? 'R$ 0,00'}}</code> - <code class="highlighter-rouge valor_mask" onLoad="mascaraMoeda(event);" style="color:red">{{$saldo_efetivo->despesa ?? 'R$ 0,00'}}</code> )
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#futura" role="tab">
                            <span class="d-block d-sm-none"><i class="ri-checkbox-circle-line"></i></span>
                            <span class="d-none d-sm-block">Mov. Futura ( <code class="highlighter-rouge valor_mask" onLoad="mascaraMoeda(event);" style="color:blue">{{$saldo_futuro->receita ?? 'R$ 0,00'}}</code> - <code class="highlighter-rouge valor_mask" onLoad="mascaraMoeda(event);" style="color:red">{{$saldo_futuro->despesa ?? 'R$ 0,00'}}</code> )
                            </span>
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-pane active" id="global" role="tabpanel">
                    <table id="dt_global" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;vertical-align: middle" class="valor_mask" onLoad="mascaraMoeda(event);">{{$movimentacao->receita}}</td>
                            <td style="text-align:right;vertical-align: middle" class="valor_mask" onLoad="mascaraMoeda(event);">{{$movimentacao->despesa}}</td>
                            <td style="text-align:right;vertical-align: middle;color: {{ ($movimentacao->receita >= $movimentacao->despesa) ? 'blue' : 'red' }}" class="valor_mask" onLoad="mascaraMoeda(event);">{{$movimentacao->saldo}}</td>
                ...
                <div class="tab-pane" id="futura" role="tabpanel">
                    <table id="dt_futura" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th data-toggle="tooltip" title="Saldo remanescente referente a Movimentação Fiscal do mês" style="text-align:right;">Saldo</th>
                            <th style="text-align:center;">Ações</th>
                        </tr>
                        </thead>
