...
class CreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'qtd_macho' => ['nullable','integer','required_if:categoria,1,3', new EstoqueValidation($this->origem ?? '')],
            'item_femea' => 'nullable|required_if:categoria,2,3',
            'qtd_femea' => ['nullable','integer','required_if:categoria,2,3', new EstoqueValidation($this->origem ?? '')],
            ...
            'gta' => 'required|max:50',
            'observacao' => 'max:1000',
            'path_gta' => 'required|mimes:jpeg,png,jpg,gif,svg,pdf|max:5120',
            'path_nota' => 'nullable|required_if:tipo,VD,CP|mimes:jpeg,png,jpg,gif,svg,pdf|max:10240',
    ...
    public function messages()
    {
        return [
            ...
            'qtd_macho.integer' => 'A Quantidade de Machos somente permite números',
            ...
            'qtd_femea.integer' => 'A Quantidade de Fêmeas somente permite números',
